package baeldung.spring.cloud.archaius.additionalsources;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,classes = AdditionalSourcesSimpleApplication.class)
